...
class StripeCapture
{
  ...
  public static function captureOrder($debug=false)
  {
    ...
    $hookObject2 = json_encode([
      "type" => "rich",
      "content" => "@everyone New website order (ID: ".$invoiceID."), visit https://https://bms-backend-setup-payou-rs8qky.herokuapp.com/-setup-payou-rs8qky.herokuapp.com//orders",
