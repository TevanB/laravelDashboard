...
<body>
                  ...
                  <div class="container mt-5">
                    ...
                    <section>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10">
                          <label class="text-light"  for="net-selector">Number of Net Wins</label>
                          <input type="range" class="custom-range" id="net-selector-duo" value="1" min="1" max="8" step="1">
                        </div>
                        <div class="col-sm-2">
                          <div class="card border-primary mb-3" style="max-width: 18rem;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-2">
                          <div class="card border-primary mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body text-white bg-light text-center align-self-center">
                              <h5 class="card-title text-dark text-center" id="placement-number-solo">1</h5>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <section class="section wow fadeIn" data-wow-delay="0.3s">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 mb-2 text-center flex-center">
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/macbook-mockup-png-3.png" alt="" class="z-depth-0 mt-5">
                        </div>
                        <!--Grid column-->
      ...
      <div class="container-fluid text-center text-md-left">
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-md-0 mb-3">
            ...
            <!-- Links -->
            <h5 class="text-uppercase footerTitle">About Us</h5>
    ...
    <script>
      var stripe = Stripe("pk_test_51I4xTLCBjNIgSDtBs3k0CXY2LeWjbcUBBXXwSYyktYGJDVml0op3k82XsdEfplkqDHgpirUKaV4wlU5azhKCe3CA0021ubCldD");
      ...
      var startStripe = function(){
        ...
        fetch("https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/create-stripe-transaction", {
          method: "POST",
          headers: {
    ...
    <script>
      ...
      paypal.Buttons({
        ...
        createOrder: function() {
          ...
          reqPrice = Math.round((reqPrice + Number.EPSILON) * 100) / 100;
        return fetch('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/create-paypal-transaction', {
          method: 'post',
          headers: {
            'content-type': 'application/json'
          },
