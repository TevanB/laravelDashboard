                   ...
                   <div class="card-body">
                      ...
                      <div class="row">
                         ...
                         <div class="col">
                            ...
                            <div class="row justify-content-center"><img id="currentRankIMG" src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/unranked.png"></div>
                            <div class="row justify-content-center">
                    ...
                    <div class="row">
                      ...
                      <div class="col" v-if="form.order_type.includes('Division')">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/bronze.png" v-if="rankStart == 'Bronze'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/iron.png" v-if="rankStart == 'Iron'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/silver.png" v-if="rankStart == 'Silver'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/gold.png" v-if="rankStart == 'Gold'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/platinum.png" v-if="rankStart == 'Platinum'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/diamond.png" v-if="rankStart == 'Diamond'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/unranked.png" v-if="rankStart == 'Unranked'"></img>

                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/master.png" v-if="rankStart == 'Master'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/grandmaster.png" v-if="rankStart == 'Grandmaster'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/challenger.png" v-if="rankStart == 'Challenger'"></img>
                        </div>
                        <div class="row justify-content-center">
                      ...
                      <div class="col" v-if="form.order_type.includes('Division')">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/bronze.png" v-if="rankEnd == 'Bronze'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/iron.png" v-if="rankEnd == 'Iron'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/silver.png" v-if="rankEnd == 'Silver'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/gold.png" v-if="rankEnd == 'Gold'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/platinum.png" v-if="rankEnd == 'Platinum'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/diamond.png" v-if="rankEnd == 'Diamond'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/master.png" v-if="rankEnd == 'Master'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/grandmaster.png" v-if="rankEnd == 'Grandmaster'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/challenger.png" v-if="rankEnd == 'Challenger'"></img>
                          <img src="https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/unranked.png" v-if="rankEnd == 'Unranked'"></img>
...
import json from './output.json';
    export default {
        ...
        watch:{
          orders: function(val){
            //console.log('change');
            axios.get('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/users/'+this.form.booster_id).then((data)=>{
              ////console.log(data);
        ...
        created(){
          ...
          if(this.$gate.hasOrderAccess(this.$route.params.order_id)){
            ...
            axios.get("https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/orders/"+this.order_id).then((data)=>{
        ...
        accessCheck(){
          let that = this;
          axios.get('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/orderinfo/'+this.order_id).then((data)=>{
...
//          let PORT = process.env.MIX_PORT || 3000;
          ...
          $.ajax({
            ...
            let ranks2 = ['Iron 4', 'Iron 3', 'Iron 2', 'Iron 1', 'Bronze 4', 'Bronze 3', 'Bronze 2', 'Bronze 1', 'Silver 4', 'Silver 3', 'Silver 2', 'Silver 1', 'Gold 4', 'Gold 3', 'Gold 2', 'Gold 1', 'Platinum 4', 'Platinum 3', 'Platinum 2', 'Platinum 1', 'Diamond 4', 'Diamond 3', 'Diamond 2', 'Diamond 1', "Master", 'GM', 'C'];
              ...
              if(info != 'Unranked' && info != 'Master' && info != 'Grandmaster' && info != 'Challenger'){
                ...
                boom = splitter[0];
                if(boom === 'Bronze'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/bronze.png");
                }else if(boom === 'Iron'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/iron.png");
                }else if(boom === 'Silver'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/silver.png");
                }else if(boom === 'Gold'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/gold.png");
                }else if(boom === 'Platinum'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/platinum.png");
                }else if(boom === 'Diamond'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/diamond.png");
                }
                ...
                if(boom === 'Unranked'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/unranked.png");
                }else if(boom === 'Master'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/master.png");

                }else if(boom === 'Grandmaster'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/grandmaster.png");

                }else if(boom === 'Challenger'){
                  $('#currentRankIMG').attr("src", "https://bms-backend-setup-payou-rs8qky.herokuapp.com/img/challenger.png");
        ...
        requestComplete(){
          ...
          axios.put('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/requestComplete/'+this.form.order_id).then(()=>{
            swal.fire(
              'Request Submitted',
          ...
          axios.put("https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/order/"+this.form.order_id, this.form).then(()=>{
            swal.fire(
              'Request Submitted',
              'Management will now inspect completion, order remains active until approved.',
              'success'
          ...
          axios.put("https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/me", this.user).then(()=>{
        ...
        requestDrop(){
          if(this.$gate.isWorkerOrAdmin){
            axios.put('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/drop/'+this.form.order_id).then((data)=>{
              swal.fire(
                'Request Submitted',
        ...
        return result;
          ...
          if(this.orders.order_status != 'reassign' && this.orders.order_status != 'reassigned'){
            swal.fire({
              ...
              if(result.value){
                ...
                axios.put('https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/reassign/'+this.order_id).then(()=>{
                  swal.fire(
                    'Request Sent',
          ...
          if(this.form.order_status == 'unclaimed'){
            ...
            axios.put("https://bms-backend-setup-payou-rs8qky.herokuapp.com/api/pause/"+this.form.order_id, this.form).then((data)=>{
              //console.log(data);
              swal.fire(
                'Order Pause Toggled',
