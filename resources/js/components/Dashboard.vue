        ...
        <div class="row">
          <div class="col">
            ...
            <div class="small-box bg-info">
              ...
              <a href="https://https://bms-backend-setup-payou-rs8qky.herokuapp.com//payments" class="small-box-footer">
          ...
          <div>
              ...
              <div class="timeline-item">
                ...
                <div class="timeline-body">
                  ...
                  <div class="timeline-footer">
                    <a href="https://https://bms-backend-setup-payou-rs8qky.herokuapp.com//profile" target="_blank" class="btn btn-primary btn-sm">Profile</a>
                  </div>
        ...
        methods:{
          notifTest(){
            ...
            confirmButtonText: 'Go To Order Page'
              ...
              if(result.value){
                window.location.replace('https://https://bms-backend-setup-payou-rs8qky.herokuapp.com//order/'+'24252');
              }
            })
          },
          getUser(){
